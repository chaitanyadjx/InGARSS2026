...
export default function Loading() {
  return (
    <div className="fixed inset-0 bg-[var(--bone)] z-[9999] flex flex-col items-center justify-center">
      {/* Loader Box */}
      ...
      <div className="w-40 sm:w-52 h-1 bg-gray-300 mt-4 border border-black">
        <div className="h-full bg-[var(--gold)] animate-[progressAnim_2s_infinite]"></div>
      </div>
