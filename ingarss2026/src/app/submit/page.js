      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-[8%] max-w-[1400px] mx-auto">
        ...
        {/* <div className="mb-10 sm:mb-12 lg:mb-16">
          ...
          {/* <div className="bg-[var(--indigo)] border-[3px] border-black p-4 sm:p-5 shadow-[6px_6px_0_black] inline-flex flex-wrap items-center gap-4">
            ...
            <a 
              href="https://cf-store.widencdn.net/ieee-org/c/d/0/cd087d07-af42-4959-b1af-b9326918154c.zip?response-content-disposition=inline%3B filename%3D%22conference-latex-template.zip%22&response-content-type=application%2Fzip&Expires=1778844563&Signature=mCed7lGfvmzcb85DVOk341nZWh58OrL1xp1j8zYZ6LZNMRalrOoGvTZG9bmWiHN9ApGxUxKUFHghtCQVBEiNc8Eb1jKp90czgwLbsVajqb5E2pM2P65hXn9EacGDlhWhcgnruJffAOz5mZAqKx75xiqHtiZ4QPMnRrRq27LOMv23u1WUS6TgwFbS~d-u0yIbbaLdunetvInddtkMeuUCFX6fXVHnvj2vmzqoWFWq5hpcaKuaduSlqMg0~J5RXoBmEw3hP4Hiw1T0sNBOCACwBsxCwgEdiK608ULpZMSfLKy7vXItcQWIac9LdabvIsJAWE1AdBeBCJVVKdKTPxOuYw__&Key-Pair-Id=APKAJD5XONOBVWWOA65A" 
              target="_blank"
